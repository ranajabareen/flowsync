        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_LeaderID",
                        column: x => x.LeaderID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PendingMemberRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PendingMemberRequests_AspNetUsers_LeaderId",
                        column: x => x.LeaderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FRNNumber = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OSSNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CaseSource = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tasks", x => x.FRNNumber);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PendingMemberRequests_LeaderId",
                table: "PendingMemberRequests",
                column: "LeaderId");

            migrationBuilder.CreateIndex(
                name: "IX_PendingMemberRequests_MemberId",
                table: "PendingMemberRequests",
                column: "MemberId");
